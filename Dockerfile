...
# Create directories
	...
	&& if test -f /home/config.inc.php; then cp /home/config.inc.php config.inc.php; echo "Using stored config in /home/config.inc.php"; else cp config.TEMPLATE.inc.php config.inc.php; echo "Copying config from template"; fi \
